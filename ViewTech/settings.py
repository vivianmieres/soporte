"""
Django settings for ViewTech project.
...
SECRET_KEY = 'django-insecure-q027m((j4asu)=--#$*ht(2p$(-d(rnw7=g(7h#f_iwplvsn*)'
...
WSGI_APPLICATION = 'ViewTech.wsgi.application'
